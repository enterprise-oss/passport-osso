...
describe('OssoStrategy', function () {
  ...
  it('should be named osso', function () {
    strategy.name.should.equal('osso');
  });
  ...
  describe('scope', function () {
    ...
    describe('array option', function () {
      ...
      before(function () {
        strategy = new OssoStrategy(options, function () {});
      });
  ...
  describe('token endpoint interaction', function () {
    ...
    describe('on success', function () {
      ...
      it('should pass the data back', function (done) {
        strategy._oauth2.getOAuthAccessToken('code', {}, function (
          err,
          accessToken,
          refreshToken,
          expires_in,
        ...
        sinon
          ...
          .callsFake(function (
            ...
            var body = JSON.stringify({
              ...
              external_urls: {
                osso: 'http://open.osso.com/user/spotifier',
              },
              email: 'example@mail.com',
              type: 'user',
              uri: 'osso:user:spotifier',
              images: [
                {
                  url:
